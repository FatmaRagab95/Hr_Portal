...
public partial class _Employee : basePageSessionExpire
{
	...
	[WebMethod]
    public static string getVacations_Requests(int user)

    {
        ...
        {
			cmd.Parameters.Add("@Requester_id", SqlDbType.Int).Value = user;
	...
	[WebMethod]
	public static string getHR_Vacations_PeriodData(int user)

	{
...

		{
			...
			cmd.Parameters.Add("@Emp_code", SqlDbType.Int).Value = user;
			SqlDataReader idr = cmd.ExecuteReader();
	...
	[WebMethod]
    public static string getrequestsData(int user)
