...
public partial class _Hr : System.Web.UI.Page
{
    ...
    populateadminusersLisst(SqlDataReader idr, SqlConnection con)
    {
        ...
        while (idr.Read())
        {
            adminusersI
                .Add(new adminusers {
                    admin_id =
                        idr["admin_id"] != DBNull.Value
                            ? Convert.ToInt32(idr["admin_id"])
                            : 0,
                    Emp_id =
    ...
    public static string getVacations_Requests()
    {
        ...
        using (
            SqlCommand cmd =
                new SqlCommand("select * from HR_Vacations_Requests", con)
        )
        {
            SqlDataReader idr = cmd.ExecuteReader();
    ...
    public static List<vacations>
    populatevacationsLisst(SqlDataReader idr, SqlConnection con)
    {
                ...
                .Add(new vacations {
                    id =
                        idr["id"] != DBNull.Value
                            ...
                            : 0,
                    Requester_id =
                        idr["Requester_id"] != DBNull.Value
                            ? Convert.ToInt32(idr["Requester_id"])
                            : 0,
                    Dept_id =
                        idr["Dept_id"] != DBNull.Value
                            ...
                            : 0,
                    Deduction_name =
                        idr["Deduction_name"] != DBNull.Value
                            ? Convert.ToString(idr["Deduction_name"])
                            : String.Empty,
                    Deduction_id =
                        idr["Deduction_id"] != DBNull.Value
                            ? Convert.ToInt32(idr["Deduction_id"])
                            : 0,
                    Vacation_Type_id =
                        idr["Vacation_Type_id"] != DBNull.Value
                            ? Convert.ToInt32(idr["Vacation_Type_id"])
                            : 0,
                    Vacation_Type_name =
                        idr["Vacation_Type_name"] != DBNull.Value
                            ? Convert.ToString(idr["Vacation_Type_name"])
                            : String.Empty,
                    Vacation_Type_Others =
                        idr["Vacation_Type_Others"] != DBNull.Value
                            ? Convert.ToString(idr["Vacation_Type_Others"])
                            : String.Empty,
                    Total_Days =
                        idr["Total_Days"] != DBNull.Value
                            ? Convert.ToInt32(idr["Total_Days"])
                            : 0,
                    Emergency_Contact =
                        idr["Emergency_Contact"] != DBNull.Value
                            ? Convert.ToString(idr["Emergency_Contact"])
                            : String.Empty,
                    Requester_Comment =
                        idr["Requester_Comment"] != DBNull.Value
                            ? Convert.ToString(idr["Requester_Comment"])
                            : String.Empty,
                    Manager_Comment =
                        idr["Manager_Comment"] != DBNull.Value
                            ? Convert.ToString(idr["Manager_Comment"])
                            : String.Empty,
                    HR_Comment =
                        idr["HR_Comment"] != DBNull.Value
                            ? Convert.ToString(idr["HR_Comment"])
                            : String.Empty,
                    Attach_File =
                        idr["Attach_File"] != DBNull.Value
                            ? Convert.ToString(idr["Attach_File"])
                            : String.Empty,
                    Status =
                        idr["Status"] != DBNull.Value
                            ? Convert.ToInt32(idr["Status"])
                            : 0,
                    Hide =
                        idr["Hide"] != DBNull.Value
                            ? Convert.ToBoolean(idr["Hide"])
                            : false,
                    HR_Hide =
                        idr["HR_Hide"] != DBNull.Value
                            ? Convert.ToBoolean(idr["HR_Hide"])
                            : false,
                    OFF_Day =
                        idr["OFF_Day"] != DBNull.Value
                            ? Convert.ToInt32(idr["OFF_Day"])
                            : 0,
                    Requester_name =
                        idr["Requester_name"] != DBNull.Value
                            ? Convert.ToString(idr["Requester_name"])
                            : String.Empty,
    ...
    public static string getrequestsData()
    {
        ...
        using (
            SqlCommand cmd =
                new SqlCommand("Select * from HR_DaysOFF_Requests where Canceled <> 'True'",
                    con)
        )
        {
            SqlDataReader idr = cmd.ExecuteReader();
    ...
    populaterequestsLisst(SqlDataReader idr, SqlConnection con)
    {
                ...
                .Add(new requests {
                    ...
                    HR_Comment =
                        idr["HR_Comment"] != DBNull.Value
                            ...
                            : String.Empty,
                    ExpirationDate =
                        (idr["ExpirationDate"] == DBNull.Value)
                            ? (DateTime?) null
                            : Convert.ToDateTime(idr["ExpirationDate"]),
                    Entry_date = Convert.ToDateTime(idr["Entry_date"])
                });
        }
    ...
    public static string getHR_Vacations_PeriodData()
    {
        ...
        List<HR_Vacations_Period> HR_Vacations_Period =
            new List<HR_Vacations_Period>();
        ...
        using (
            SqlCommand cmd =
                new SqlCommand("Select * from HR_Vacations_Period", con)
        )
        {
            SqlDataReader idr = cmd.ExecuteReader();
            ...
            {
                HR_Vacations_Period =
                    populateHR_Vacations_PeriodLisst(idr, con);
            }
        }
    ...
    public static List<HR_Vacations_Period>
    populateHR_Vacations_PeriodLisst(SqlDataReader idr, SqlConnection con)
    {
        List<HR_Vacations_Period> HR_Vacations_PeriodI =
            new List<HR_Vacations_Period>();

        while (idr.Read())
        {
            HR_Vacations_PeriodI
                .Add(new HR_Vacations_Period {
                    Request_id =
                        idr["Request_id"] != DBNull.Value
                            ? Convert.ToInt32(idr["Request_id"])
                            : 0,
                    Emp_id =
                        idr["Emp_code"] != DBNull.Value
                            ? Convert.ToInt32(idr["Emp_code"])
                            : 0,
                    Type_id =
                        idr["Type_id"] != DBNull.Value
                            ? Convert.ToInt32(idr["Type_id"])
                            : 0,
                    Date_from =
                        idr["Date_from"] != DBNull.Value
                            ? Convert.ToString(idr["Date_from"])
    ...
    public static List<StatusDetails>
    populateStatusDetailsLisst(SqlDataReader idr, SqlConnection con)
    {
    ...
    public static string Rejection(HR_DaysOFF_Requests request)
    {
        ...
        List<HR_DaysOFF_Requests> HR_DaysOFF_Requests =
            new List<HR_DaysOFF_Requests>();
        ...
        SqlCommand cmd =
            new SqlCommand("update HR_DaysOFF_Requests set HR_Comment= @HR_Comment, Status= @Status where id = @id;",
                con);
        {
    ...
    public static string updateVacStatus(StatusVacDetails detail)
    {
        ...
        using (
            SqlCommand cmd =
                new SqlCommand("update HR_Vacations_Requests set Status= @Status where id = @id;",
                    con)
        )
        {
            cmd.Parameters.AddWithValue("@id", detail.id);
    ...
    public static List<StatusVacDetails>
    populateStatusVacDetailsLisst(SqlDataReader idr, SqlConnection con)
    {
    ...
    public static string updateHide(HideDetails detail)
    {
        ...
        using (
            SqlCommand cmd =
                new SqlCommand("update HR_Vacations_Requests set HR_Hide= @HR_Hide where id = @id;",
                    con)
        )
        {
            cmd.Parameters.AddWithValue("@id", detail.id);
    ...
    public static string getPeriodsData(HR_Vacations_Period detail)
    {
        ...
        using (
            SqlCommand cmd =
                new SqlCommand("SELECT * FROM HR_Vacations_Period WHERE Emp_code = @Emp_id and Request_id IN (SELECT id FROM HR_Vacations_Requests WHERE Vacation_Type_name = 'Casual' and Status = 4)",
                    con)
        )
        {
    ...
    public static string checkBalance(HR_Employees_Vacation_Balance detail)
    {
        ...
        using (
            SqlCommand cmd =
                new SqlCommand("select * from  HR_Employees_Vacation_Balance where Emp_id = @Emp_id",
                    con)
        )
        {
            cmd.Parameters.AddWithValue("@Emp_id", detail.Emp_id);
            ...
            if (idr.HasRows)
            {
                HR_Employees_Vacation_Balance =
                    populateHR_Employees_Vacation_BalanceLisst(idr, con);
            }
        }
    ...
    public static string updateBalance(HR_Employees_Vacation_Balance detail)
    {
        ...
        using (
            SqlCommand cmd =
                new SqlCommand("update HR_Employees_Vacation_Balance set Annual_Balance= @Annual_Balance, Casual_Balance= @Casual_Balance, Old_Balance= @Old_Balance,Off_Balance= @Off_Balance,Q1= @Q1,Q2= @Q2,Q3= @Q3,Q4= @Q4,Old_Balance_ExpirationDate = @Old_Balance_ExpirationDate where Emp_id = @Emp_id;",
                    con)
        )
        {
            cmd.Parameters.AddWithValue("@Emp_id", detail.Emp_id);
            cmd
                .Parameters
                .AddWithValue("@Annual_Balance", detail.Annual_Balance);
            cmd
                .Parameters
                .AddWithValue("@Casual_Balance", detail.Casual_Balance);
    ...
    public static List<HR_Employees_Vacation_Balance>
    populateHR_Employees_Vacation_BalanceLisst(
        SqlDataReader idr,
        SqlConnection con
    )
    {
        List<HR_Employees_Vacation_Balance> EmpBalanceI =
            new List<HR_Employees_Vacation_Balance>();

        while (idr.Read())
        {
            EmpBalanceI
                .Add(new HR_Employees_Vacation_Balance {
                    ...
                    Off_Balance =
                        idr["Off_Balance"] != DBNull.Value
                            ? Convert.ToInt32(idr["Off_Balance"])
                            : 0,
    ...
    public static string updateOffDays(EmpOffDays detail)
    {
        ...
        using (
            SqlCommand cmd =
                new SqlCommand("update HR_Employees_Vacation_Balance set Off_Balance= @Off_Balance where Emp_id = @Emp_id;",
                    con)
        )
        {
            cmd.Parameters.AddWithValue("@Emp_id", detail.Emp_id);
    ...
    public static List<EmpOffDays>
    populateEmpOffDaysLisst(SqlDataReader idr, SqlConnection con)
    {
    ...
    public static string getPages()
    {
        ...
        using (
            SqlCommand cmd =
                new SqlCommand("SELECT Menu.* FROM User_Authority INNER JOIN Menu ON User_Authority.menu_id = Menu.id and User_Authority.admin_id=@admin_id",
                    con)
        )
        {
            cmd.Parameters.Add("@admin_id", SqlDbType.Int).Value =
                HttpContext.Current.Session["admin_id"];
            SqlDataReader idr = cmd.ExecuteReader();
    ...
    populatepagesLisst(SqlDataReader idr, SqlConnection con)
    {
    ...
    public static string updateWorkHide(HideWorkDetails detail)
    {
        ...
        using (
            SqlCommand cmd =
                new SqlCommand("update HR_DaysOFF_Requests set HR_Hide= @HR_Hide where id = @id;",
                    con)
        )
        {
            cmd.Parameters.AddWithValue("@id", detail.id);
    ...
    public static List<HideWorkDetails>
    populateHideWorkDetailsLisst(SqlDataReader idr, SqlConnection con)
    {
