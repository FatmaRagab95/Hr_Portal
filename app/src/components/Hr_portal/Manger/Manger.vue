  ...
  <div class="hr-portal internal-page" id="Manger">
    ...
    <div class="custom-form manger-vec fortab">
      <div class="cu-container">
        <div
          class="cu-form-group special shadow pb-5 pt-3 m-auto bg-light"
          style="max-width: 95%"
        >
          <ul
            class="nav nav-tabs md-tabs bg-secondary text-white p-3 mb-2 shadow rounded"
            id="myTabMD"
            role="tablist"
          >
            <li class="nav-item">
          ...
          <div class="tab-content card pt-3 m-0 w-100 rounded shadow" id="myTabContentMD">
            <div
              ...
              style="max-height: 600px padding-top: 10px;"
            >
              <div v-if="VacRrq.length > 0">
                <div class="row m-0" v-for="(request, i) in VacRrq" :key="request.id">
                  <div class="col-lg-12">
                                  ...
                                  <div class="f-15 mb-0">
                                    <div class="text-muted">
                                      ...
                                      <span
                                        >Vacation Type :
                                        <span
                                          v-if="request.Deduction_name.trim() == 'Paid'"
                                          class="text-success"
                                          >{{ request.Vacation_Type_name }}</span
                                        >
                              ...
                              <div class="row mt-3">
                                <div class="col-md-12">
                                  <div>
                                    <a
                                      href="#"
                                      @click.prevent="updateVacStatus(request.id, 2)"
                                      :class="
                                        ([2, 3, 4, 5].indexOf(request.Status) > -1
                                          ? 'disabled '
                                    ...
                                    <a
                                      href="#"
                                      @click.prevent="updateVacStatus(request.id, 3)"
                                      :class="
                                        ([2, 3, 4, 5].indexOf(request.Status) > -1
                                          ? 'disabled '
                              ...
                              <div class="row">
                                <div class="col-md-10">
                                  ...
                                  >
                                    ...
                                    >Request Status :
                                    <span v-if="request.Status == 1" class="text-primary"
                                      >requested</span
                                    >
                                    <span
            ...
            >
              <div v-if="WorkRequests.length > 0">
                <div
                  class="row m-0"
                  v-for="(request, i) in WorkRequests"
                  :key="request.id"
                >
                  <div class="col-lg-12">
                            ...
                            <div class="candidates-list-desc job-single-meta pt-2">
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-6">
                                  <p class="text-muted f-15 mb-0">
                                    <i
                                      class="fa fa-pencil-square mr-2"
                                      aria-hidden="true"
                                    ></i
                                    >Request Status :
                                    <span v-if="request.Status == 1" class="text-primary"
                              ...
                              <div class="row">
                                <div class="col-md-12">
                                  <div class="">
                                    <a
                                      href="#"
                                      @click.prevent="updateWorkStatus(request.id, 2)"
                                      :class="
                                        ([2, 3, 4, 5].indexOf(request.Status) > -1
                                          ? 'disabled '
                                          : '') + 'btn btn-sm btn-success'
                                    ...
                                    <a
                                      href="#"
                                      @click.prevent="updateWorkStatus(request.id, 3)"
                                      :class="
                                        ([2, 3, 4, 5].indexOf(request.Status) > -1
                                          ? 'disabled '
                                          : '') + 'btn btn-sm btn-danger'
                              ...
                              <div class="row">
                                <div class="col-md-6">
                                  <p class="text-muted mb-2 f-14 pull-left text-danger">
                                    <i class="fa fa-list mr-3" aria-hidden="true"></i
                                    >Employee Comment :
                                    <span v-if="request.Requester_Comment">{{
                                ...
                                <div class="col-md-6">
                                  <a href="#" class="pull-right">
                                    <i
                                      ...
                                      aria-hidden="true"
                                      @click.prevent="
                                        deleteWorkRequest(request.id, true, i)
                                      "
                                    >
                                    </i>
                                  </a>
              ...
              <div v-else class="card">
                <div class="card-body text-center">There is no work requests yet!</div>
              </div>
            </div>
            <div
              class="tab-pane fade overflow-auto"
            ...
            >
              <table
                class="table table-bordered text-center shadow-sm table-striped mt-2"
              >
                ...
                <tbody class="bg-white">
                  <tr v-for="(imp, i) in adminusersData" :key="imp.admin_id">
                    <th>{{ i + 1 }}</th>
                    <th>
                      <img
                        src="../../../assets/layout/img/person.jpg"
                    ...
                    <th
                      v-if="
                        HR_Employees_Vacation_Balance.filter(
                          (x) => x.Emp_id == imp.Emp_id
                        ).length > 0
                      "
                    >
                      {{
                    ...
                    <th>
                      <a
                        href="#"
                        class="btn btn-sm btn-secondary open-pop"
                        data-pop-name="imp-details-popup"
                        v-on:click.prevent="impReqPopUp(imp, 'impDetailsPop')"
                        >show details</a
                      >
                    </th>
                  </tr>
    ...
    <div v-if="vacRequest">
      <div
        v-bind:class="
          vacRequest['detailsPop'] ? 'details-popup popup active' : 'details-popup popup'
        "
                  ...
                  <div class="social-timeline-card shadow">
                    <div class="card-header bg-secondary text-white">
                      <ul class="nav nav-tabs card-header-tabs tab">
                        <li class="nav-item">
                          <a class="nav-link tablinks stylish" data-tab="#request-details"
                            >Request Details
                          </a>
                        </li>
                        <li class="nav-item">
                        ...
                        >
                          <div class="row">
                            <div class="cu-field col-md-12">
                              <h3 class="cu-label">
                                <label
                                  >In case of emergency, We can we cotact you by :</label
                                >
                              </h3>
                              <div class="cu-input text-box" style="max-width: 100%">
                                <span class="fa fa-edit"></span>
                        ...
                        >
                          <div class="row">
                            <div class="cu-field col-md-12">
                              ...
                              <div
                                v-if="vacRequest.Requester_Comment"
                                class="cu-input text-box"
                                style="max-width: 100%"
                              >
                                <span class="fa fa-edit"></span>
                        ...
                        <div class="col-md-12 graph">
                          ...
                          >
                            ...
                            <tbody class="bg-white">
                              ...
                              >
                                <th>{{ i + 1 }}</th>
                                <td v-if="request.Deduction_name.trim() == 'Paid'">
                                ...
                                <td v-else-if="request.Status == 2" class="text-success">
                                  Accepted from manger
                                </td>
                                <td v-else-if="request.Status == 3" class="text-danger">
                                  Rejected from manger
                                </td>
                                <td v-else-if="request.Status == 4" class="text-success">
                                  Accepted from HR
                                </td>
    ...
    <div v-if="impRequest">
      <div
        v-bind:class="
          impRequest['impDetailsPop']
            ? 'imp-details-popup popup active'
            : 'imp-details-popup popup'
        "
        v-if="impRequest['impDetailsPop'] == true"
      >
        <div class="popup-body" style="max-width: 1000px">
          <div class="container-fluid custom-form m-auto pb-4" style="max-width: 800px">
            <div class="cu-container">
              ...
              <div class="col-md-12">
                ...
                <div>
                  <div class="social-timeline-card shadow">
                    <div class="card-body">
                      <div
                        class="col-md-12 graph"
                        v-if="
                          allVacRrq.filter((x) => x.Requester_id == impRequest.Emp_id)
                            .length > 0
                        "
                      >
                        <table class="table table-bordered text-center shadow-sm">
                          ...
                          <tbody>
                            <tr
                              class="align-middle"
                              v-for="(Req, i) in allVacRrq.filter(
                                (x) => x.Requester_id == impRequest.Emp_id
                              )"
                              :key="Req.id"
                              v-show="
                                HR_Vacations_Period.filter((x) => x.Request_id == Req.id)
                                  .length > 0
                              "
                            >
                              <td>{{ i + 1 }}</td>
                              <td v-if="Req.Deduction_name.trim() == 'Paid'">
                                {{ Req.Vacation_Type_name }}
                              </td>
                              ...
                              <td
                                v-show="
                                  HR_Vacations_Period.filter(
                                    (x) =>
                                      x.Request_id == Req.id && x.Date_from == x.Date_to
                                  ).length > 0
                                "
                              >
                                {{
                                  HR_Vacations_Period.filter(
                                    (x) => x.Request_id == Req.id
                                  )
                                    .map((x) => x.Date_from)
                                    .join()
                                    .replace(/,/g, "  ,  ")
                              ...
                              <td v-if="Req.Status == 1" class="text-primary">
                                requested
                              </td>
                              <td v-else-if="Req.Status == 2" class="text-success">
                                Accepted from manger
                              </td>
                              <td v-else-if="Req.Status == 3" class="text-danger">
                                Rejected from manger
                              </td>
                              <td v-else-if="Req.Status == 4" class="text-success">
                                Accepted from HR
                              </td>
                              <td v-else-if="Req.Status == 5" class="text-danger">
                                Rejected from HR
                              </td>
                            </tr>
                            <tr
                      ...
                      <div class="text-center text-secondary" v-else>
                        There is no vacation requests for this employee
                      </div>
                    </div>
                  </div>
                </div>
...
export default {
      ...
      if (status == 2) {
        swal({
          ...
          if (confirm) {
            ...
            $.ajax({
              type: "POST",
              url: that.apiUrl + "Hr_Portal/Manger.aspx/updateStatus",
          ...
          if (willReject) {
            swal({
              ...
              if (reason.trim()) {
                $.ajax({
                  type: "POST",
                  url: that.apiUrl + "Hr_Portal/Manger.aspx/Rejection",
                  data: JSON.stringify({
                    request: { Manager_Comment: reason, id: id, Status: status },
                  }),
                  contentType: "application/json; charset=utf-8",
                  dataType: "json",
                  success: function () {
      ...
      if (status == 2) {
        swal({
          ...
          if (confirm) {
            ...
            $.ajax({
              type: "POST",
              url: that.apiUrl + "Hr_Portal/Manger.aspx/updateVacStatus",
              data: JSON.stringify({ detail: { id: id, Status: status } }),
              contentType: "application/json; charset=utf-8",
              dataType: "json",
              success: function () {
                if (that.VacRrq.filter((x) => x.id == id)[0].Vacation_Type_id == 103) {
                  ...
                  $.ajax({
                    ...
                    data: JSON.stringify({
                      detail: {
                        id: that.VacRrq.filter((x) => x.id == id)[0].OFF_Day,
                        Status: 7,
                      },
                    }),
                    contentType: "application/json; charset=utf-8",
          ...
          if (willReject) {
            swal({
              ...
              if (reason.trim()) {
                $.ajax({
                  type: "POST",
                  url: that.apiUrl + "Hr_Portal/Manger.aspx/VacRejection",
                  data: JSON.stringify({
                    request: { Manager_Comment: reason, id: id, Status: status },
                  }),
                  contentType: "application/json; charset=utf-8",
    ...
    deleteVacRequest: function (id, hide, i) {
      ...
      swal({
        ...
        if (result) {
          $.ajax({
            type: "POST",
            url: cobject.apiUrl + "Hr_Portal/Manger.aspx/updateHide",
    ...
    deleteWorkRequest: function (id, hide, i) {
      ...
      swal({
        ...
        if (result) {
          $.ajax({
            type: "POST",
            url: cobject.apiUrl + "Hr_Portal/Manger.aspx/updateWorkHide",
  ...
  created: function () {
    ...
    $.ajax({
      type: "POST",
      url: cobject.apiUrl + "Hr_Portal/Manger.aspx/getadminusersData",
      contentType: "application/json; charset=utf-8",
      dataType: "json",
    ...
    $.ajax({
      type: "POST",
      url: cobject.apiUrl + "Hr_Portal/Manger.aspx/getrequestsData",
      contentType: "application/json; charset=utf-8",
      dataType: "json",
      success: function (data) {
        cobject.requests = JSON.parse(data.d);
        cobject.WorkRequests = cobject.requests.filter(
          (x) => x.Canceled == false || x.Manager_Hide == false
        );
      },
    });
    ...
    $.ajax({
      type: "POST",
      url: cobject.apiUrl + "Hr_Portal/Manger.aspx/getVacations_Requests",
      contentType: "application/json; charset=utf-8",
      dataType: "json",
      success: function (data) {
        ...
        cobject.VacRrq = cobject.Vacations_Requests.filter(
          (x) => x.Hide == false || x.Hide_Manager == false
        );
      },
    });
    ...
    $.ajax({
      type: "POST",
      url: cobject.apiUrl + "Hr_Portal/Manger.aspx/getHR_Employees_Vacation_BalanceData",
      contentType: "application/json; charset=utf-8",
      dataType: "json",
      success: function (data) {
    ...
    $.ajax({
      type: "POST",
      url: cobject.apiUrl + "Hr_Portal/Manger.aspx/getHR_Vacations_PeriodData",
      contentType: "application/json; charset=utf-8",
      dataType: "json",
      success: function (data) {
